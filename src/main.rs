...
// const RECOGNIZED_FILE_TYPES: [&'static str; 76] = [
//     // General-purpose programming languages
//     "rs", "py", "c", "h", "cpp", "hpp", "java", "js", "ts", "tsx", "jsx", "go",
//     "rb", "php", "swift", "kt", "kts", "cs", "vb", "fs", "scala", "pl", "pm",
//     "r", "jl", "sh", "bat", "ps1", "lua",
...
//     // Hardware description and low-level
//     "v", "sv", "vhdl", "asm", "s", "ada", "f90", "f95", "f03", "f08",
